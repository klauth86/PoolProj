...
#include "MyArmComponent.generated.h"


UCLASS( ClassGroup=(Custom), meta=(BlueprintSpawnableComponent) )
class POOLPROJA_API UMyArmComponent : public USceneComponent {
	GENERATED_BODY()

public:
	UMyArmComponent(const FObjectInitializer& ObjectInitializer);
