 ...
 */
UCLASS()
class POOLPROJC_API UMyPawnMovementComponent : public UPawnMovementComponent, public IRVOAvoidanceInterface, public INetworkPredictionInterface {
	GENERATED_BODY()
public:
...
public:
	...
	*/
	 ...
	 */
	virtual bool StepUp(const FVector& GravDir, const FVector& Delta, const FHitResult &Hit, struct UMyPawnMovementComponent::FStepDownResult* OutStepDownResult = NULL);
...
protected:
	...
	/** Called by UMyPawnMovementComponent::VerifyClientTimeStamp() when a client timestamp reset has been detected and is valid. */
	 ...
	 * Called by UMyPawnMovementComponent::VerifyClientTimeStamp() for valid timestamps.
	 */
	...
	/**
	 * Called by UMyPawnMovementComponent::ProcessClientTimeStampForTimeDiscrepancy() (on server) when the time from client moves
...
public:
	 ...
	 * For example:
	 *		Client: UMyPawnMovementComponent::ServerMove(...) => Calls CharacterOwner->ServerMove(...) triggering RPC on server
